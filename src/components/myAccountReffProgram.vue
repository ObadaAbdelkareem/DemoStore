		...
		<div class="list affiliate_lst">
			...
			<div class="list_top ">
				<div class="order_search clearfix">
					<div class="tt sort_by">Sort by :</div>
					<ul class="list-inline">
												<li>
							<label>
								<div class="radio"><span class="checked"><input type="radio" name="sort-by" value="1" checked="" data-url="/index.php?com=account&amp;t=affiliateReport&amp;sort=1"></span></div>Most Popular
							</label>
						</li>
												<li>
							<label>
					...
					<form onsubmit="return checkAffiliateSearch('affiliate_keyword');" method="post" action="/index.php?com=account&amp;t=affiliateReport" id="affiliate_search_form">
												<input type="text" autocomplete="off" value="" placeholder="SEARCH" class="inputchang keywrods" name="affiliate_keyword" style="border: 1px #dedede solid;">
			...
			<div class="category_content_goods">
...
<style>
.affiliate_lst .list_top .order_search {
    min-width: 478px;
    border: none;
    overflow: visible;
    width: 100%;
}
.list .order_search .searchbtn {
